...
using namespace llanalyzer::Wrapper;

WrapperAnalyzer::WrapperAnalyzer() : llanalyzer::Analyzer("WrapperAnalyzer"), protocol(0), currentPacket(nullptr) {
}

WrapperAnalyzer::~WrapperAnalyzer() = default;

uint32_t WrapperAnalyzer::getIdentifier(Packet* packet) {
...
void WrapperAnalyzer::analyze(Packet* packet) {
