...
using namespace llanalyzer::Ethernet;

EthernetAnalyzer::EthernetAnalyzer() : llanalyzer::Analyzer("EthernetAnalyzer"), protocol(0), currentPacket(nullptr) {
}

EthernetAnalyzer::~EthernetAnalyzer() = default;

uint32_t EthernetAnalyzer::getIdentifier(Packet* packet) {
...
void EthernetAnalyzer::analyze(Packet* packet) {
